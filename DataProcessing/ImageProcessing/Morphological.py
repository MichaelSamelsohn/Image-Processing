...
def erosion(image, kernel, iterations):
    ...
    log.debug("Finished performing erosion on an image")
    return eroded_image
...
def dilation(image, kernel, iterations):
    ...
    log.debug("Finished performing dilation on an image")
...
def opening(image, kernel):
    ...
    log.debug("Finished performing opening on an image")
    return opened_image
...
def closing(image, kernel):
    ...
    log.debug("Finished performing closing on an image")
    return closed_image
...
def morphGradient(image, kernel):
    ...
    log.debug("Finished performing morphological gradient on an image")
